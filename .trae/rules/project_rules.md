...
**Quick reference — all 188 guards by category:**
...
| 错误处理 | 18 | 错误不吞、不假成功、用户可理解（含 R108 api client result no throw, R129 JSON.parse try/catch, R134 delete dialog disable on referenced, R136 bulk-save failures, R192 quality-gate no throw, R195 usage record no block） |
