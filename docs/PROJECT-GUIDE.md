...
> 版本：0.12.2 | 许可证：UNLICENSED | 最后更新：2026-07-04
...
3. **13 个 AI Provider 插件**：volcengine、kuaishou、zhipu、pixverse、seedance、google、openai-sora、minimax、anthropic、openai-compatible。每个插件实现 IVideoProvider 接口，通过 DI 容器注册。
