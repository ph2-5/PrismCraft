// AI: All database table/column definitions live here. Check before adding new tables or columns.
...
export const FEATURE_TABLES: TableDef[] = [
  {
    name: "video_tasks",
    featureGroup: "video",
    columns: {
...
export const CACHE_TABLES: TableDef[] = [
  {
    name: "video_cache",
    featureGroup: "video",
    baseColumns: false,
