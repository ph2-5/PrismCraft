...
export const DEFAULT_SHOT_SEQUENCES = [
  {
    ...
    shotTypes: [
      { shotType: "wide", duration: 3 },
      { shotType: "medium", duration: 2 },
      { shotType: "close", duration: 2 },
      { shotType: "medium", duration: 2 },
      { shotType: "close", duration: 2 },
      { shotType: "wide", duration: 2 },
    ],
  },
  {
    id: "action_sequence",
    ...
    shotTypes: [
      { shotType: "wide", duration: 2 },
      { shotType: "medium", duration: 1 },
      { shotType: "close", duration: 1 },
      { shotType: "medium", duration: 1 },
      { shotType: "low", duration: 2 },
      { shotType: "close", duration: 1 },
      { shotType: "wide", duration: 2 },
    ],
  },
  {
    ...
    shotTypes: [
      { shotType: "wide", duration: 3 },
      { shotType: "medium", duration: 2 },
      { shotType: "close", duration: 3 },
      { shotType: "extreme_close", duration: 2 },
    ],
  },
] as const;
