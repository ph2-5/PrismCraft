/**
 * Help Tools 静态字典与辅助函数
 *
 * 从 help-tools.ts 拆分出来，包含：
 * - FEATURE_DOCS：功能说明字典
 * - TUTORIALS：教程字典
 * - HELP_DOCS：帮助文档数组
 * - KEYBOARD_SHORTCUTS：键盘快捷键字典
 * - safeParseJson：安全 JSON 解析辅助函数
 *
 ...
 */
export const FEATURE_DOCS: Record<
  string,
 ...
 * 键盘快捷键字典
 */
export const KEYBOARD_SHORTCUTS: Array<{ key: string; description: string; context: string }> = [
  // 全局
