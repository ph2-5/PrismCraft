  ...
  return (
    <div className="border-b border-border px-5 py-3 flex flex-row items-center justify-between bg-muted/30 shrink-0">
      <div className="flex items-center gap-3">
        <button
          type="button"
          className="btn btn-ghost btn-xs hover:bg-muted text-muted-foreground hover:text-foreground h-8 w-8"
          onClick={onClose}
      ...
      <div className="flex items-center gap-1">
        <button
          type="button"
          className="btn btn-ghost btn-xs text-muted-foreground hover:text-foreground hover:bg-muted h-8 w-8"
          onClick={onPrevBeat}
          disabled={index === 0}
        ...
        <button
          type="button"
          className="btn btn-ghost btn-xs text-muted-foreground hover:text-foreground hover:bg-muted"
          onClick={onNextBeat}
